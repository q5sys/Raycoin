...
void GpuBuffer::Create( const std::wstring& name, uint32_t NumElements, uint32_t ElementSize, const void* initialData, D3D12_RESOURCE_STATES initialResourceState)
{
    GpuResource::Destroy();
