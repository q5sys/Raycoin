...
namespace GameCore
{
    ...
    public:
        ...
        void SetMoveSpeed(float speed)  { m_MoveSpeed = speed; m_StrafeSpeed = speed; }
        ...
        void SetCurrentHeading(float heading) { m_CurrentHeading = heading; ResetMomentum(); }
        void SetCurrentPitch(float pitch) { m_CurrentPitch = pitch; ResetMomentum(); }
