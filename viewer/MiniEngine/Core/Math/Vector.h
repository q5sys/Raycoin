...
namespace Math
{
    ...
    {
    public:
        INLINE ScalarRef(XMVECTOR& v, int i)        : _v(v), _i(i) {}
        INLINE ScalarRef(ScalarRef& ref)            : _v(ref._v), _i(ref._i) {}

        INLINE ScalarRef& operator =  (float f)     { _v = XMVectorSetByIndex(_v, f, _i); return *this; }
        INLINE ScalarRef& operator += (float f)     { _v = XMVectorSetByIndex(_v, *this + f, _i); return *this; }
        INLINE ScalarRef& operator -= (float f)     { _v = XMVectorSetByIndex(_v, *this - f, _i); return *this; }
        INLINE ScalarRef& operator *= (float f)     { _v = XMVectorSetByIndex(_v, *this * f, _i); return *this; }
        INLINE ScalarRef& operator /= (float f)     { _v = XMVectorSetByIndex(_v, *this / f, _i); return *this; }

        INLINE operator float() const               { return XMVectorGetByIndex(_v, _i); }
    ...
    public:
        ...
        INLINE Scalar operator[](int i) const   { return XMVectorGetByIndex(m_vec, i); }
        INLINE ScalarRef operator[](int i)      { return ScalarRef(m_vec, i); }
    ...
    public:
        ...
        INLINE Scalar operator[](int i) const   { return XMVectorGetByIndex(m_vec, i); }
        INLINE ScalarRef operator[](int i)      { return {m_vec, i}; }
