...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " raycoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  raycoin-tx [options] <hex-tx> [commands]  Update hex-encoded raycoin transaction\n" +
            "or:     raycoin-tx [options] -create [commands]   Create hex-encoded raycoin transaction\n" +
            "\n";
